...
public final class Constants {
    ...
    public static class Arm {
        ...
        public static double ArmChainSpeed = 0.02;
        public static double ArmChainSpeedRev = -0.02; // Chain reverse speed

        public static double ArmExtensionSpeed = 0.02;
        public static double ArmExtensionSpeedRev = -0.02;
