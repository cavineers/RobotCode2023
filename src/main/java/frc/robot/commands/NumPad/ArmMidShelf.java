...
public class ArmMidShelf extends CommandBase {
    ...
    if(Robot.armAngle.getArmChainMotorPosition() < (Constants.Arm.MidNodeShelfAngleRotations) - Constants.Arm.AngleEncoderDeadzone) {
        Robot.armAngle.getArmChainMotor().set(Constants.Arm.ArmChainSpeedUp + (Constants.Arm.MidNodeShelfAngleRotations - Robot.armAngle.getArmChainMotorPosition())/100 );
        Robot.armAngle.getArmChainMotor2().set(-(Constants.Arm.ArmChainSpeedUp - (Constants.Arm.MidNodeShelfAngleRotations - Robot.armAngle.getArmChainMotorPosition())/100 ));
        this.isDone = false;
