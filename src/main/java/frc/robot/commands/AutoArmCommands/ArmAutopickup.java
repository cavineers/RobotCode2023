...
public class ArmAutopickup extends CommandBase {
    
    private boolean isDone;
    private double m_timestamp;

    public ArmAutopickup() {
    ...
    public void execute() {
        ...
        if(Robot.armAngle.getArmChainMotorPosition() < (Constants.Arm.ArmAutoAngleRotations) - Constants.Arm.AngleEncoderDeadzone) {
            ...
            this.isDone = false;
        } else if (Robot.armExtension.getArmExtensionMotorPosition() < (Constants.Arm.ArmAutoExtensionRotations) - Constants.Arm.ExtensionEncoderDeadzone) {
            ...
            this.isDone = false;
        } else if (Robot.armAngle.getArmChainMotorPosition() > (Constants.Arm.ArmAutoAngleRotations) + Constants.Arm.AngleEncoderDeadzone) {
