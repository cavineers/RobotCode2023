...
public class TopPeg extends CommandBase {
    ...
    if(Robot.arm.getArmChainMotorPosition() < 17) {
        ...
        this.isDone = false;
    } else if(Robot.arm.getArmExtensionMotorPosition() > 20) {      
        Robot.arm.setArmExtensionMotorState(Arm.ArmExtensionMotorState.REVERSED);
        this.isDone = false;
    } else if (Robot.arm.getArmChainMotorPosition() > 20) {
